...
Route.create(name: 'Ruta 1', starts_at: Time.zone.local(2022, 9, 10, 9, 0, 0), ends_at: Time.zone.local(2022, 9, 10, 11, 30, 0))
Route.create(name: 'Ruta 2', starts_at: Time.zone.local(2022, 9, 10, 9, 0, 0), ends_at: Time.zone.local(2022, 9, 10, 10, 10, 0))
Route.create(name: 'Ruta 3', starts_at: Time.zone.local(2022, 9, 10, 11, 0, 0), ends_at: Time.zone.local(2022, 9, 10, 13, 30, 0), vehicle_id: Vehicle.first.id, driver_id: Driver.first.id, aasm_state: 'assigned')